...
class Corpus(object):
    def __init__(self, path):
        ...
        # iiself.test = tokenize(self.dictionary, os.path.join(path, 'test.txt'))
...
def tokenize(dictionary, path):
    ...
    with open(path, 'r', encoding="utf8") as f:
        ...
        for i,line in enumerate(f):
            ...
            #     token += 1
            list_of_tokenized_sent.append([dictionary.word2idx[word] for word in words])
    
    return list_of_tokenized_sent
